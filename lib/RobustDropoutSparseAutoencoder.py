...
import SparseDropoutAutoencoder as sdae
...
class RobustDropoutSparseAutoencder():
    ...
    Des:
        ...
        Where the Encoder is with dropout
    ...
    def __init__(self, sess, layers_sizes, sparsities, lambda_=1.0):
        ...
        self.SAE = sdae.Sparse_Dropout_Autoencoder( sess = sess, input_dim_list = self.layers_sizes,
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        L, S = rsae.fit(x, sess = sess, inner_iteration = 40, iteration = 30,verbose = True)
