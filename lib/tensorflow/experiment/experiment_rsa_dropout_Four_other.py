import numpy as np
import RobustDropoutSparseAutoencoder as RSA
# import ImShow as I
...
def oneRun(x,layers_sizes,sparsities,lam):
    with tf.Graph().as_default():
        with tf.Session() as sess:
            rsa = RSA.RobustDropoutSparseAutoencder(sess, layers_sizes = layers_sizes, sparsities = sparsities, lambda_=lam)
...
if __name__ == "__main__":
    sparce_list = np.arange(0.0,0.5,0.1)
    # lam_list = [0.0,0.05,0.1,0.2,0.3,0.5,1.0,3.0,3.5,4.0,4.5,5.0]
    lam_list = [1.0, 2.0, 3.0, 5.0, 8.0, 13.0, 21.0]
    x = np.load(r"/home/czhou2/Documents/Four_with_other_p5.pkl")
    layers_sizes = [784,784,784,784]
    result_target_folder = r"/research/czhou2/Result/rsa_dropout_FourWithOther"
