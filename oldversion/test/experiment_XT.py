...
def compare_frame():
    ...
    #lamda_list = np.arange(0.0003,0.0008,0.00005)
    lamda_list = np.arange(0.0008,0.0020,0.00005)
    ...
    for lam in lamda_list:
        ...
        RDAE_DAE_l21RDAE_compressUser(X = X.T, layers=layers, lamda = lam, folder = folder, learning_rate = 0.15, inner = inner, outer = outer, batch_size = 133,inputsize = (28,28))
